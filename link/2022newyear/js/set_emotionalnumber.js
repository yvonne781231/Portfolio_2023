(function ($){
    ...
    $.fn.aniEvent = function () {
        ...
        $('.cameralink').load('/dadamaster_public/event/camera_link/camera.html?t=20210617');
        ...
        function onScroll(event) {
            ...
            //Sec5加上Fixed
            if (scrollPos >= $('#section-items').position().top && (scrollPos - 250 + $(window).height()) <= $('#Sec51').position().top) {
